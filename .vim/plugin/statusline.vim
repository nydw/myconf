...
fun! s:SetFullStatusline() "{{{
  ...
  setlocal statusline+=%#StatuslineFileName#\%F\                       " file full name
...
hi StatuslineFileName  cterm=none    ctermfg=white  ctermbg=057     gui=none guibg=#d59159 guifg=black
hi StatuslineFileEnc   cterm=none    ctermfg=black  ctermbg=227     gui=none guibg=#ffff77 guifg=black
hi StatuslineFileType  cterm=bold    ctermbg=white  ctermfg=black   gui=none guibg=#acff84 guifg=black
hi StatuslineTermEnc   cterm=none    ctermbg=white  ctermfg=black   gui=none guibg=#77cf77 guifg=black
hi StatuslineChar      cterm=none    ctermbg=white  ctermfg=black   gui=none guibg=#66b06f guifg=black
hi StatuslineSyn       cterm=none    ctermbg=white  ctermfg=black   gui=none guibg=#60af9f guifg=black
hi StatuslineRealSyn   cterm=none    ctermbg=white  ctermfg=black   gui=none guibg=#5881b7 guifg=black
hi StatusLine          cterm=none    ctermbg=white  ctermfg=black   gui=none guibg=#3f4d77 guifg=#729eb0 
