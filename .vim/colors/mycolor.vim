...
elseif &t_Co == 256
	...
	" -> LGX Code
	hi Comment        ctermbg=234  ctermfg=240   cterm=none  "" Comment
    ...
    hi StorageClass   ctermbg=234  ctermfg=162   cterm=bold  ""static const
    hi Character      ctermbg=234  ctermfg=191   cterm=bold 
    hi Number         ctermbg=234  ctermfg=191   cterm=bold 
    hi Boolean        ctermbg=234  ctermfg=191   cterm=bold 
